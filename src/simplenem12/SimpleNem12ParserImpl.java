...
public class SimpleNem12ParserImpl implements SimpleNem12Parser {
    ...
    public void parseLines(List<String[]> lines) throws ParsingException {
        ...
        for (String line[] : lines) {
            ...
            if (currentLine == 1 && !recordType.equals("100")) {
                throwParsingError(currentLine,"First line must be a 100 record type");
            }

            if (recordType.equals("100")) {
                parse100(currentLine);
    ...
    private void parse100(int currentLine) throws ParsingException {
        if(currentLine>1) {
            throwParsingError(currentLine,"File must only have a 100 record type on the first line");
        }
